...
pub const kitty_graphics_render_placement_iterator_new = kitty_graphics.render_placement_iterator_new;
pub const kitty_graphics_render_placement_iterator_free = kitty_graphics.render_placement_iterator_free;
pub const kitty_graphics_render_placement_iterator_set = kitty_graphics.render_placement_iterator_set;
pub const kitty_graphics_render_placement_iterator_update = kitty_graphics.render_placement_iterator_update;
pub const kitty_graphics_render_placement_next = kitty_graphics.render_placement_next;
pub const kitty_graphics_render_placement_get = kitty_graphics.render_placement_get;
